...
export const sendMail = async (email, subject, url) => {
  try {
    ...
    await transporter.sendMail({
      ...
      html: emailTemplate(url, subject),
    });
...
const emailTemplate = (url, subject) => {
                            ...
                            <tr>
                              <td alignItem="left">
                                <table cellpadding="0" cellspacing="0">
                                  <tbody>
                                    <tr>
                                      <td> <a href=${url} target="_blank">${subject}</a> </td>
                                    </tr>
                                  </tbody>
                                </table>
                              </td>
